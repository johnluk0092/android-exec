...
public class NumberTextWatcher implements TextWatcher {
    private static final String LOG_TAG = "NumberTextWatcher";
    ...
    public void afterTextChanged(Editable s) {
        ...
        try {
            int initLength = this.editText.getText().length();
            ...
            if (this.hasFractionalPart) {
                ...
                int trailingZeros = countTrailingZeros(v);
            ...
            int selection = selectionStart + (endLength - initLength);
            ...
            Log.e(LOG_TAG, "Error parsing number: " + nfe.getMessage());
        }
